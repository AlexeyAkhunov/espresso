...
{
    int var;
    pcube d=cube.temp[0], temp=cube.temp[1], temp1=cube.temp[2];
...
{
    pcube mask, diff, and0, temp, temp1 = cube.temp[0];
    int var;
    pcover r;
