...
void
variable_list_init(int reduced_c_free_count, int * reduced_c_free_list)
{
	int i;
	int v, next_v;
...
void
variable_list_delete(int element)
{
	variable_count--;
...
void
variable_list_insert(int element)
{
	variable_count++;
	if(variable_head != -1){
...
void
get_next_variable(int * pv,int * pphase, pcover R)
{
	int v,e0,e1;
