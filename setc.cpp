...
int descend(const void* v1, const void* v2) {
    const pset * a = static_cast<const pset *>(v1);
    const pset * b = static_cast<const pset *>(v2);
    pset a1 = *a, b1 = *b;
...
int ascend(const void * v1, const void * v2) {
    const pset* a = static_cast<const pset*>(v1);
    const pset* b = static_cast<const pset*>(v2);
    pset a1 = *a, b1 = *b;
    if (SIZE(a1) > SIZE(b1)) return 1;
...
int lex_order(const void * v1, const void * v2){
    const pset * a = static_cast<const pset*>(v1);
    const pset * b = static_cast<const pset*>(v2);
    pset a1 = *a, b1 = *b;
    int i = LOOP(a1);
...
int d1_order(const void * v1, const void * v2) {
    const pset * a = static_cast<const pset*>(v1);
    const pset * b = static_cast<const pset*>(v2);
