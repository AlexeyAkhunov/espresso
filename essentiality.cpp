 ...
 */
pcover
etr_order(pcover F,pcover E,pcover R,pcube c,pcube d)
{
...
int
ascending(const void * v1,const void * v2)
{
    const VAR* p1 = static_cast<const VAR*>(v1);
    const VAR* p2 = static_cast<const VAR*>(v2);
 ...
 */
void
aux_etr_order(pcover F, pcover E, pcover R, pcube c, pcube d)
{
	pcover  minterms;
	pcube d_minterm;
	pcube sigma_d;
