...
pcover primes_consensus(pcube * T /* T will be disposed of */)
{
    pcube cl, cr;
    int best;
    pcover Tnew, Tl, Tr;
...

static bool 
primes_consensus_special_cases(
pcube *T,			/* will be disposed if answer is determined */
pcover *Tnew			/* returned only if answer determined */)
{
...

static pcover 
primes_consensus_merge(pcover Tl, pcover Tr, pcube cl, pcube cr)
{
...
static pcover
and_with_cofactor(pset_family A, pset cof)
{
    pset last, p;
